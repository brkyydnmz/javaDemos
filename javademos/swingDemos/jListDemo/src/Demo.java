...
public class Demo extends javax.swing.JFrame {
    ...
    public Demo() {
        ...
        //model.add(0, "Engin");   //yine eleman ekler bu da baştaki 0 mesela modelin 0.elemanı olacağını belirtir 
        //model.removeElement("Derin");  //listeden çıkarır 
    ...
    private void initComponents() {
        ...
        lstStudents.setFont(new java.awt.Font("Dialog", 2, 14)); // NOI18N
        ...
        lblName.setFont(new java.awt.Font("Dialog", 2, 14)); // NOI18N
        ...
        btnAdd.setBackground(java.awt.Color.darkGray);
        btnAdd.setFont(new java.awt.Font("Dialog", 2, 14)); // NOI18N
        ...
        btnRemove.setFont(new java.awt.Font("Dialog", 2, 14)); // NOI18N
        ...
        btnRemoveSelected.setBackground(java.awt.Color.darkGray);
        btnRemoveSelected.setFont(new java.awt.Font("Dialog", 2, 14)); // NOI18N
        ...
        lblMessage.setFont(new java.awt.Font("Franklin Gothic Medium", 2, 22)); // NOI18N
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(btnRemoveSelected, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE))
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        model.addElement(txtName.getText());  //txt de yazılan elementi buraya getirir listeye ekler yani 
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        model.removeElement(txtName.getText());   //txt (text) de yazan elementi siler listeden
    ...
    private void btnRemoveSelectedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveSelectedActionPerformed
        ...
        int index = lstStudents.getSelectedIndex();  //seçili olan indexin numarasını verir.
        if(index != -1){    //eğer şeçili birşey yoksa listede çoğu dildeki gibi sistem -1 döndürür bu yüzden hata verier hatayı kaldırmak için if döngüsüne aldık
            model.removeElementAt(index);   //indexi siler int şeklinde
        }else{
