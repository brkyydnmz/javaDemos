...
public class demo extends javax.swing.JFrame {
    ...
    public void populateTable(){
        model = (DefaultTableModel)tblCities.getModel();  //varolan model üstüne yazar listeyi
        model.setRowCount(0);
    ...
    public ArrayList <City> getCities() throws SQLException{
        ...
        ResultSet resultSet;
        ArrayList<City> cities=null;   //burda da newleyebiliriz ancak hata olursa bellekte boşu boşuna durur tryda kullanmak daha mantıklıdır
    ...
    private void initComponents() {
        ...
        tblCities.setForeground(java.awt.Color.black);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtSearch))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(lblCountryCode, javax.swing.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
                            .addComponent(lblName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tbxName, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(tbxDistrict, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(tbxPopulation, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        TableRowSorter<DefaultTableModel> tableRowSorter = 
                new TableRowSorter<DefaultTableModel>(model);   //ilgili modeli kullanarak nesneyi oluşturduk burada
        tblCities.setRowSorter(tableRowSorter);  //oluşan nesneyi burada jtable(liste) mize bağlamış olduk
        tableRowSorter.setRowFilter(RowFilter.regexFilter(searchKey));  //filtre geçtik burada da
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try{
            ...
            statement.setInt(4,Integer.valueOf(tbxPopulation.getText()));   //Integer.valueOf ile integer a çevirdik string i
            int result = statement.executeUpdate();
            populateTable();       //tablomuza ekleme yaptıkça yenilemeyi sağlar.
        }catch(SQLException exception){
            dbHelper.showErrorMessage(exception);
        }finally{
            try {
